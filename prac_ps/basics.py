...
def km_2_mi():  # distance converter converting Km to miles 
...
def login():
        """
        building a secure Login Gate. 
        We'll use a "State Machine" entire behavior changes depending 
        on how global variable dials are flipped!

        Create 3 variables right below this comment:
        ...
        Inside else block, write the following logic:
